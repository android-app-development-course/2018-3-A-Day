...
public class ptEditor extends EditText {
    private final String TAG = "ptEditor";
    ...
    public ptEditor(Context context) {
        super(context);
        init(context);
    }

    public ptEditor(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public ptEditor(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public Bitmap getSmallBitmap(String filePath, int reqWidth, int reqHeight) {
        ...
        int w_height = w_screen * b_height / b_width;
